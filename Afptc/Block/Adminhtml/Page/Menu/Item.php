...
namespace Aheadworks\Afptc\Block\Adminhtml\Page\Menu;

use Aheadworks\Afptc\Block\Adminhtml\Page\Menu;
 ...
 *
 * @package Aheadworks\Afptc\Block\Adminhtml\Page\Menu
 */
class Item extends Template
{
     ...
     * @var string
     */
    protected $_template = 'Aheadworks_Afptc::page/menu/item.phtml';
