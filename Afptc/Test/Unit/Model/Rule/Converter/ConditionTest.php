...
class ConditionTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->conditionFactoryMock = $this->createPartialMock(ConditionInterfaceFactory::class, ['create']);

        $this->conditionConverter = $objectManager->getObject(
    ...
    public function testArrayToDataModel($conditions)
    {
        ...
        $this->assertEquals($conditionMock, $this->conditionConverter->arrayToDataModel($conditions));
    }
    ...
    public function testDataModelToArray($conditions)
    {
        ...
        $this->assertEquals($conditions, $this->conditionConverter->dataModelToArray($dataModelMock));
    }
