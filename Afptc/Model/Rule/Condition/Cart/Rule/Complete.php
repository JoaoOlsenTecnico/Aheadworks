...
use Aheadworks\Afptc\Block\Adminhtml\Rule\Edit\Tab\Conditions\Complete\Form as CompleteForm;
 ...
 */
class Complete extends AbstractCart
{
    /**
     * Condition prefix
     */
    const CONDITION_PREFIX = 'complete';
    ...
    protected function _resetConditions($conditions = null)
    {
        ...
        $this->getConditions($conditions)
            ->setId('1')
            ->setPrefix(CompleteForm::CONDITION_FIELD_NAME);
        return $this;
    }
}
